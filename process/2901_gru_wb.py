...
def getFMFTRL():
    ...
    Hash name
    '''
    wb = wordbatch.WordBatch(normalize_text, extractor=(WordBag, {"hash_ngrams": 3, "hash_ngrams_weights": [1.5, 1.0, 0.5],
    ...
    msk = np.array(np.clip(X_name.getnnz(axis=0) - 2, 0, 1), dtype=bool)
