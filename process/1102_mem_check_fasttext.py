...
def trainFMFTRL(moddict):
    ...
    moddict['sparse_merge_mask'] =  np.where(train_X.getnnz(axis=0) > 5)[0]
    train_X = csc_matrix(train_X[:, moddict['sparse_merge_mask']])
    valid_X = csc_matrix(valid_X[:, moddict['sparse_merge_mask']])
